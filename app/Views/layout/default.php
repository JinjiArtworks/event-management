        ...
        <div class="main-wrapper">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="/logout" class="dropdown-item has-icon text-danger" id="logout" data-confirm="Keluar?|Apakah anda yakin untuk logout ?" data-confirm-yes="returnLogout()">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= site_url() ?>">Married With Us</a>
                        <!-- linked into same url, using site url -->
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2021 <div class="bullet"></div> Developed By <a href="">Jinji Artworks</a>
                </div>
